#define MyAppName "VisionVoice Plugin"
#define MyAppVersion "3.1"
#define MyAppPublisher "Mamali"
#define MyAppURL "https://github.com/RealMamali/visionvoice"
...
begin
	...
	then
		begin
			...
			then MsgBox('�������� ���������� � GTA!', mbInformation, MB_OK)
