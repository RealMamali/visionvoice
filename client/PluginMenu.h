...
private:
    ...
    static constexpr auto kTitleText                       = "Vision Voice Panel";
    static constexpr auto kTab1TitleText                   = "Speaker";
    static constexpr auto kTab1Desc1TitleText              = "Sound";
    static constexpr auto kTab1Desc1EnableSoundText        = "Toggle speaker";
    static constexpr auto kTab1Desc1VolumeSoundText        = "Speaker volume";
    ...
    static constexpr auto kTab1Desc3TitleText              = "Speaker icons";
    static constexpr auto kTab1Desc3SpeakerIconScaleText   = "Size";
    ...
    static constexpr auto kTab1Desc4TitleText              = "Other";
    ...
    static constexpr auto kTab2Desc1EnableMicroText        = "Toggle microphone";
    ...
    static constexpr auto kTab2Desc1CheckDeviceText        = "Hear your own voice (only on Vision Voice Panel)";
    static constexpr auto kTab2Desc2TitleText              = "Microphone icon";
    static constexpr auto kTab2Desc2MicroIconScaleText     = "Size";
    ...
    static constexpr auto kTab2Desc2MicroIconMoveText      = "Edit with mouse";
    static constexpr auto kTab2Desc3MicroNotFoundText      = "No microphones available";
    static constexpr auto kTab3TitleText                   = "Blacklist";
    static constexpr auto kTab3Desc1TitleText              = "Filter";
    static constexpr auto kTab3Desc1InputPlaceholderText   = "Type PlayerID/Nickname";
    static constexpr auto kTab3Desc2PlayerListText         = "Online players";
